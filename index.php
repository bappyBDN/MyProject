<?php
  ...
  if(isset($_POST['add_to_cart'])){
    ...
    if(mysqli_num_rows($select_cart) > 0){
       ...
       $insert_product = mysqli_query($conn, "INSERT INTO `cart`(name, price, image, quantity,IG_ID) VALUES('$product_name', '$product_price', '$product_image', '$product_quantity','$product_Id')");
...
<nav class="navbar navbar-expand-lg p-3 fs-6 navbar-primary .bg-green">
  <div class="container-fluid">
    <a class="navbar-brand" href="index.php"><h1>Fasion World</h1></a>
      ...
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end p-4" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item" href="userlogin.php"><h2>User</h2></a></li>
            <li><a class="dropdown-item" href="ProducerLogIN.php"><h2>Producer</h2></a></li>
